...
def parent_text(tags, tags2, tags3):
    max_length = 0
    for tag in tags:
        ...
        for parent in parents:
            if parent.text != '\n\t\t\t':
                # print(parent.tag)
                dict1[tag].append(parent.text)
            else:
                dict1[tag].append(None)
    ...
    for t2 in tags3:
        ...
        for ch2 in childs2:
            if ch2.text != '\n\t\t\t':
                # print(ch2.tag)
                dict3[t2].append(ch2.text)
            else:
                # dict3[t2].append(None)
                print('none')
